...
import { Loader2, Home } from 'lucide-react'; // Import Loader2 and Home icons
...
export default function ReportsPage() {
    ...
    const [resolutionTimeData, setResolutionTimeData] = useState<{
        byType: { dimension: string; average_resolution_time: string | null }[] | null;
        byPriority: { dimension: string; average_resolution_time: string | null }[] | null;
        byAgent: { dimension: string; average_resolution_time: string | null }[] | null;
    } | null>(null);
            ...
            <Tabs defaultValue="overview" onValueChange={handleTabChange}>
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        <TabsContent value="ticket-volume" className="mt-4">
                            {ticketVolumeData && (
                                <Card>
                                         ...
                                         {agentPerformanceData.length > 0 ? (
                                            <ResponsiveContainer width="100%" height={300}>
                                                ...
                                                >
                                                    ...
                                                    {/* Average Resolution Time could be a line on a combined chart, or shown in tooltip */}
                                                    {/* For now, showing in tooltip via formatter */}
                                                </BarChart>
                                            </ResponsiveContainer>
                                        ) : (
                                         ...
                                         {resolutionTimeData.byType && resolutionTimeData.byType.length > 0 ? (
                                            <ResponsiveContainer width="100%" height={300}>
                                                ...
                                                >
                                                    <CartesianGrid strokeDasharray="3 3" />
                                                    <XAxis dataKey="dimension" />
                                                    {/* YAxis might need a custom tick formatter if data is string */}
                                                    <YAxis />
                                                    <Tooltip />
                                                    <Legend />
                                                    {/* DataKey might need adjustment if average_resolution_time is not directly plottable */}
                                                    <Bar dataKey="average_resolution_time" fill="#8884d8" name="Avg. Resolution Time" />
                                                </BarChart>
                                            </ResponsiveContainer>
                                        ) : (
                                         ...
                                         {resolutionTimeData.byPriority && resolutionTimeData.byPriority.length > 0 ? (
                                            <ResponsiveContainer width="100%" height={300}>
                                                ...
                                                >
                                                    ...
                                                    <Legend />
                                                    {/* DataKey might need adjustment if average_resolution_time is not directly plottable */}
                                                    <Bar dataKey="average_resolution_time" fill="#82ca9d" name="Avg. Resolution Time" />
                                                </BarChart>
                                            </ResponsiveContainer>
                                        ) : (
                                         ...
                                         {resolutionTimeData.byAgent && resolutionTimeData.byAgent.length > 0 ? (
                                            <ResponsiveContainer width="100%" height={300}>
                                                ...
                                                >
                                                    ...
                                                    <Legend />
                                                    {/* DataKey might need adjustment if average_resolution_time is not directly plottable */}
                                                    <Bar dataKey="average_resolution_time" fill="#ff8042" name="Avg. Resolution Time" />
                                                </BarChart>
                                            </ResponsiveContainer>
                                        ) : (
                        ...
                        <TabsContent value="customer-reports" className="mt-4">
                            {customerTicketCounts && (
                                <Card>
                                    <CardHeader><CardTitle>Customer Reports</CardTitle></CardHeader>
                                    <CardContent>
                                         <h4 className="text-lg font-semibold mb-4">Ticket Count by Customer</h4>
                                         {customerTicketCounts.length > 0 ? (
                                            ...
                                            <p className="text-muted-foreground">No data available for ticket count by customer.</p>
                                        )}
                                    </CardContent>
                                </Card>
                            )}
